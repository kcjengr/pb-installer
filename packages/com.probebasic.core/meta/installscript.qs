...
Component.prototype.createOperations = function()
{
    ...
    component.addOperation("Execute", "pip", "install", "--upgrade", "probe-basic==v0.0.8", "UNDOEXECUTE", "pip", "uninstall", "--yes", "probe-basic==v0.0.8");
    component.addOperation("CreateDesktopEntry", "@HomeDir@/.local/share/applications/ProbeBasicSim.desktop", "Version=1.0\nType=Application\nTerminal=false\nExec=linuxcnc @HomeDir@linuxcnc/configs/probe_basic/probe_basic.ini\nName=ProbeBasic SIM\nIcon=@HomeDir@/.local/share/pixmaps/probebasic.png");
