...
Component.prototype.createOperations = function()
{
    ...
    var package_version = component.name;
    var package_version2 = component.version;
    ...
    component.addOperation("Execute", "python", "-m", "pip", "install", "--user", "--upgrade", "@TargetDir@/dist/probe_basic-"+ package_version2 + "-py2-none-any.whl", "UNDOEXECUTE", "python", "-m", "pip", "uninstall", "--yes", "probe_basic");
