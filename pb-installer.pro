...
probebasic.commands += $$(HOME)/Qt/QtIFW-3.2.0/bin/repogen -p $$PWD/packages -i com.probebasic.core,com.probebasic.fonts,com.probebasic.nc,com.probebasic.sim $$PWD/repo;
