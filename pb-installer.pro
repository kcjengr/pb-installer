...
probebasic.commands += $$(HOME)/Qt/QtIFW-4.4.1/bin/repogen --remove --update -p $$PWD/packages $$PWD/repo;
probebasic.commands += $$(HOME)/Qt/QtIFW-4.4.1/bin/binarycreator -p $$PWD/packages --config $$PWD/config/config.xml $$PWD/bin/${QMAKE_FILE_OUT};
